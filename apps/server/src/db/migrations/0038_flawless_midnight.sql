CREATE TABLE "mail0_imap_config" (
	...
	"last_sync_uidvalidity" text,
	"last_sync_uid" integer,
	"folder_structure" jsonb,
	"created_at" timestamp NOT NULL,
	"updated_at" timestamp NOT NULL,
	CONSTRAINT "mail0_imap_config_connection_id_unique" UNIQUE("connection_id")
);
...
ALTER TABLE "mail0_imap_config" ADD CONSTRAINT "mail0_imap_config_connection_id_mail0_connection_id_fk" FOREIGN KEY ("connection_id") REFERENCES "public"."mail0_connection"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
CREATE INDEX "imap_config_connection_id_idx" ON "mail0_imap_config" USING btree ("connection_id");--> statement-breakpoint
CREATE INDEX "imap_config_imap_host_idx" ON "mail0_imap_config" USING btree ("imap_host");--> statement-breakpoint
